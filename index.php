        ...
        <div class="card-body table-responsive">
            <table class="table table-bordered table-hover align-middle">
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/ascii.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/char_length.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/character_length.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/concat.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/concat_ws.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/left.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/right.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/length.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/lower.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/upper.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/replace.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/reverse.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/trim.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/substring.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/string_functions/instr.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
                
                <tr>
                    <td>FIELD()</td>
                    <td>Returns index position of title in a list</td>
                    <td><code>SELECT FIELD(title,'Inception','Parasite','Superbad') FROM movies;</code></td>
                    <td><a href="functions/string_functions/field.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>FIND_IN_SET()</td>
                    <td>Find title inside a set of values</td>
                    <td><code>SELECT FIND_IN_SET(title,'Inception,Parasite,Superbad') FROM movies;</code></td>
                    <td><a href="functions/string_functions/find_in_set.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>FORMAT()</td>
                    <td>Format release year with commas</td>
                    <td><code>SELECT FORMAT(release_year,0) FROM movies;</code></td>
                    <td><a href="functions/string_functions/format.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>INSERT()</td>
                    <td>Insert text into title</td>
                    <td><code>SELECT INSERT(title,1,0,'Movie: ') FROM movies;</code></td>
                    <td><a href="functions/string_functions/insert.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>LCASE()</td>
                    <td>Convert title to lowercase</td>
                    <td><code>SELECT LCASE(title) FROM movies;</code></td>
                    <td><a href="functions/string_functions/lcase.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>LOCATE()</td>
                    <td>Locate letter 'e' in title</td>
                    <td><code>SELECT LOCATE('e',title) FROM movies;</code></td>
                    <td><a href="functions/string_functions/locate.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>LPAD()</td>
                    <td>Pad title on the left</td>
                    <td><code>SELECT LPAD(title,20,'*') FROM movies;</code></td>
                    <td><a href="functions/string_functions/lpad.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>LTRIM()</td>
                    <td>Remove leading spaces from title</td>
                    <td><code>SELECT LTRIM(title) FROM movies;</code></td>
                    <td><a href="functions/string_functions/ltrim.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>MID()</td>
                    <td>Extract part of title starting from position 2</td>
                    <td><code>SELECT MID(title,2,5) FROM movies;</code></td>
                    <td><a href="functions/string_functions/mid.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>POSITION()</td>
                    <td>Find position of 'e' in title</td>
                    <td><code>SELECT POSITION('e' IN title) FROM movies;</code></td>
                    <td><a href="functions/string_functions/position.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>REPEAT()</td>
                    <td>Repeat title twice</td>
                    <td><code>SELECT REPEAT(title,2) FROM movies;</code></td>
                    <td><a href="functions/string_functions/repeat.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>RPAD()</td>
                    <td>Pad title on the right</td>
                    <td><code>SELECT RPAD(title,20,'*') FROM movies;</code></td>
                    <td><a href="functions/string_functions/rpad.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>RTRIM()</td>
                    <td>Remove trailing spaces from title</td>
                    <td><code>SELECT RTRIM(title) FROM movies;</code></td>
                    <td><a href="functions/string_functions/rtrim.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>SPACE()</td>
                    <td>Return 10 spaces</td>
                    <td><code>SELECT SPACE(10);</code></td>
                    <td><a href="functions/string_functions/space.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>STRCMP()</td>
                    <td>Compare title with 'Inception'</td>
                    <td><code>SELECT STRCMP(title,'Inception') FROM movies;</code></td>
                    <td><a href="functions/string_functions/strcmp.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>SUBSTR()</td>
                    <td>Extract part of title</td>
                    <td><code>SELECT SUBSTR(title,1,6) FROM movies;</code></td>
                    <td><a href="functions/string_functions/substr.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>SUBSTRING_INDEX()</td>
                    <td>Extract part of title before space</td>
                    <td><code>SELECT SUBSTRING_INDEX(title,' ',1) FROM movies;</code></td>
                    <td><a href="functions/string_functions/substring_index.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>

                <tr>
                    <td>UCASE()</td>
                    <td>Convert title to uppercase</td>
                    <td><code>SELECT UCASE(title) FROM movies;</code></td>
                    <td><a href="functions/string_functions/ucase.php" target="_blank" class="btn btn-sm btn-dark">View Output</a></td>
                </tr>
...
<div class="card shadow mt-5">
    ...
    <div class="card-body table-responsive">
        <table class="table table-bordered table-hover align-middle">
            ...
            <tr>
                <td>ACOS()</td>
                <td>Arc cosine of rating score</td>
                <td><code>SELECT ACOS(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/acos.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>ASIN()</td>
                <td>Arc sine of rating score</td>
                <td><code>SELECT ASIN(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/asin.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>ATAN()</td>
                <td>Arc tangent of rating score</td>
                <td><code>SELECT ATAN(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/atan.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>ATAN2()</td>
                <td>Arc tangent of price and rating</td>
                <td><code>SELECT ATAN2(price, rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/atan2.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>COS()</td>
                <td>Cosine of rating score</td>
                <td><code>SELECT COS(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/cos.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>COT()</td>
                <td>Cotangent of rating score</td>
                <td><code>SELECT COT(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/cot.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>DEGREES()</td>
                <td>Convert radians to degrees</td>
                <td><code>SELECT DEGREES(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/degrees.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>EXP()</td>
                <td>e raised to rating score</td>
                <td><code>SELECT EXP(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/exp.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>LN()</td>
                <td>Natural log of rating score</td>
                <td><code>SELECT LN(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/ln.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>LOG()</td>
                <td>Log of rating score base 2</td>
                <td><code>SELECT LOG(2, rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/log.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>LOG10()</td>
                <td>Log base 10 of rating score</td>
                <td><code>SELECT LOG10(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/log10.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>LOG2()</td>
                <td>Log base 2 of rating score</td>
                <td><code>SELECT LOG2(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/log2.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>
            ...
            <tr>
                ...
                <td><a href="functions/numeric_functions/pi.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>RADIANS()</td>
                <td>Convert rating score to radians</td>
                <td><code>SELECT RADIANS(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/radians.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>SIN()</td>
                <td>Sine of rating score</td>
                <td><code>SELECT SIN(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/sin.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>

            <tr>
                <td>TAN()</td>
                <td>Tangent of rating score</td>
                <td><code>SELECT TAN(rating_score) FROM movies;</code></td>
                <td><a href="functions/numeric_functions/tan.php" target="_blank" class="btn btn-sm btn-success">View Output</a></td>
            </tr>
    ...
    <div class="card-body table-responsive">
        <table class="table table-bordered table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td>HOUR()</td>
                    <td>Hour part of CURTIME()</td>
                    <td><code>SELECT HOUR(CURTIME());</code></td>
                    <td><a href="functions/date_functions/hour.php" target="_blank" class="btn btn-sm btn-primary">View Output</a></td>
                </tr>
        ...
        <table class="table table-bordered table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/bin.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/binary.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><code>SELECT CASE WHEN rating &gt;= 8 THEN 'High' ELSE 'Low' END FROM movies;</code></td>
                        <td><a href="functions/advanced_functions/case.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/cast.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/coalesce.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/connection_id.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/conv.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/convert.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/current_user.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/database.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/ifnull.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/isnull.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/last_insert_id.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/nullif.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/session_user.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/system_user.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/user.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><a href="functions/advanced_functions/version.php" target="_blank" class="btn btn-sm btn-danger">View Output</a></td>
                </tr>
